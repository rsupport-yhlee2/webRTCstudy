...
class RTCAudioManager(context: Context) {
    ...
    private inner class WiredHeadsetReceiver() : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent) {
            ...
            Log.e("Rsupport", "WiredHeadsetReceiver.onReceive"
    ...
    fun start(audioManagerEvents: AudioManagerEvents?) {
        Log.e("Rsupport", "start")
        ThreadUtils.checkIsOnMainThread()
        if (amState == AudioManagerState.RUNNING) {
            Log.e("Rsupport", "AudioManager is already active")
            return
        }
...
//        }
        ...
        Log.e("Rsupport", "AudioManager starts...")
        ...
        audioFocusChangeListener =
            OnAudioFocusChangeListener { focusChange ->
                ...
                Log.e("Rsupport", "onAudioFocusChange: $typeOfChange")
            }
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            Log.e("Rsupport", "Audio focus request granted for VOICE_CALL streams")
        } else {
            Log.e("Rsupport", "Audio focus request failed")
        }
        ...
        Log.e("Rsupport", "AudioManager started")
    }
    ...
    fun stop() {
        ...
        Log.e("Rsupport", "Abandoned audio focus for VOICE_CALL streams")

        audioManagerEvents = null
        Log.e("Rsupport", "AudioManager stopped")
    }

    /** Changes selection of the currently active audio device.  */
    private fun setAudioDeviceInternal(device: AudioDevice?) {
        Log.e("Rsupport", "setAudioDeviceInternal(device=$device)")
        if (audioDevices.contains(device)) {
            when (device) {
                ...
                else -> Log.e("Rsupport", "Invalid audio device selection")
            }
        }
    ...
    fun setDefaultAudioDevice(defaultDevice: AudioDevice?) {
        ...
        when (defaultDevice) {
            ...
            else -> Log.e("Rsupport", "Invalid default audio device selection")
        }
        Log.e("Rsupport", "setDefaultAudioDevice(device=$defaultAudioDevice)")
        updateAudioDeviceState()
    }
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            for (device: AudioDeviceInfo in devices) {
                ...
                if (type == AudioDeviceInfo.TYPE_WIRED_HEADSET) {
                    Log.e("Rsupport", "hasWiredHeadset: found wired headset")
                    return true
                } else if (type == AudioDeviceInfo.TYPE_USB_DEVICE) {
                    Log.e("Rsupport", "hasWiredHeadset: found USB audio device")
                    return true
                }
            }
            return false
    ...
    init {
        ...
        Log.e("Rsupport", "useSpeakerphone: $useSpeakerphone")
        if ((useSpeakerphone == SPEAKERPHONE_FALSE)) {
            defaultAudioDevice = AudioDevice.EARPIECE
        } else {
            defaultAudioDevice = AudioDevice.SPEAKER_PHONE
        }
        Log.e("Rsupport", "defaultAudioDevice: $defaultAudioDevice")
    }
}